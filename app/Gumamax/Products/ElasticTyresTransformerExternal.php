 ...
 */
class ElasticTyresTransformerExternal extends Transformer {
    ...
    public function transform($product){
        return [
            ...
            'price_with_tax'=>$product['_source']['list_price'],
            'price_without_tax'=>$product['_source']['list_price']*100/(100+$product['_source']['tax_rate']),
