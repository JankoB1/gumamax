...
return [
    ...
    'ErrorIdentifier'=>[
            ...
            '800.100.402' => 'ERROR_CC_INVALIDDATA', // Nažalost, podaci o kartici koje ste uneli nisu taèni. Molimo pokušajte ponovo.
            ...
            '800.300.401' => 'ERROR_CC_BLACKLIST', // Unfortunately, the credit card you entered can not be accepted. Please choose a different card or payment method.

            '800.100.171' => 'ERROR_CC_DECLINED_CARD', // Unfortunately, the credit card you entered can not be accepted. Please choose a different card or payment method.
            ...
            '100.100.303' => 'ERROR_CC_EXPIRED', // Unfortunately, the credit card you entered is expired. Please choose a different card or payment method.

            '800.100.153' => 'ERROR_CC_INVALIDCVV', // Unfortunately, the CVV/CVC you entered is not correct. Please try again.
            '100.100.601' => 'ERROR_CC_INVALIDCVV',
            '800.100.192' => 'ERROR_CC_INVALIDCVV',

            '800.100.157' => 'ERROR_CC_EXPIRY', // Unfortunately, the expiration date you entered is not correct. Please try again.

            '800.100.162' => 'ERROR_CC_LIMIT_EXCEED', // Unfortunately, the limit of your credit card is exceeded. Please choose a different card or payment method.

            '100.400.040' => 'ERROR_CC_3DAUTH', // Unfortunately, the 3D Secure password you entered was not correct. Please try again.
            ...
            '100.390.105' => 'ERROR_CC_3DERROR', //  Unfortunately, there has been an error while processing your 3D Secure request. Please try again.
            ...
            '100.100.500' => 'ERROR_CC_NOBRAND', // Unfortunately, there has been an error while processing your request. Please try again.

            '800.100.155' => 'ERROR_GENERAL_LIMIT_AMOUNT', // Unfortunately, your credit limit is exceeded. Please choose a different card or payment method.
            '000.100.203' => 'ERROR_GENERAL_LIMIT_AMOUNT',
            '100.550.310' => 'ERROR_GENERAL_LIMIT_AMOUNT',
            '100.550.311' => 'ERROR_GENERAL_LIMIT_AMOUNT',

            '800.120.101' => 'ERROR_GENERAL_LIMIT_TRANSACTIONS', // Unfortunately, your limit of transaction is exceeded. Please try again later.
            ...
            '800.100.152' => 'ERROR_CC_DECLINED_AUTH', // Unfortunately, your transaction has failed. Please choose a different card or payment method.
            '000.400.106' => 'ERROR_CC_DECLINED_AUTH',
            '000.400.105' => 'ERROR_CC_DECLINED_AUTH',
  /*DUPLI*/          '000.400.103' => 'ERROR_CC_DECLINED_AUTH',

            '100.380.501' => 'ERROR_GENERAL_DECLINED_RISK', //  Unfortunately, your transaction has failed. Please choose a different card or payment method.

            '800.400.151' => 'ERROR_CC_ADDRESS', // We are sorry. We could no accept your card as its origin does not match your address.
            '800.400.150' => 'ERROR_CC_ADDRESS',

            '100.400.300' => 'ERROR_GENERAL_CANCEL', // You cancelled the payment prior to its execution. Please try again.
            '100.396.101' => 'ERROR_GENERAL_CANCEL',
            '900.300.600' => 'ERROR_GENERAL_CANCEL',

            '800.100.501' => 'ERROR_CC_RECURRING', // Recurring transactions have been deactivated for this credit card. Please choose a different card or payment method.
            '800.100.500' => 'ERROR_CC_RECURRING',

            '800.100.178' => 'ERROR_CC_REPEATED', // Unfortunately, your transaction has been declined due to invalid data. Please choose a different card or payment method.
            '800.300.500' => 'ERROR_CC_REPEATED',
            '800.300.501' => 'ERROR_CC_REPEATED',

            '800.700.101' => 'ERROR_GENERAL_ADDRESS', // Unfortunately, your transaction has failed. Please check the personal data you entered.
            ...
            '100.400.121' => 'ERROR_GENERAL_BLACKLIST', // The chosen payment method is not available at the moment. Please choose a different card or payment method.
            ...
            '000.100.200' => 'ERROR_GENERAL_GENERAL', // Unfortunately, your transaction has failed. Please try again.
            ...
            '000.400.107' => 'ERROR_GENERAL_TIMEOUT', // Nažalost, vaša transakcija nije uspela. Molimo pokušajte ponovo.
            '100.395.502' => 'ERROR_GENERAL_TIMEOUT',



            '700.400.100' => 'ERROR_CAPTURE_BACKEND', // Transakciju nije moguæe kompletirati.
            '700.400.101' => 'ERROR_CAPTURE_BACKEND',
            '700.400.510' => 'ERROR_CAPTURE_BACKEND',

            '800.100.500' => 'ERROR_REORDER_BACKEND', // Korisnik kartice je zahtevao od svoje banke da zaustavi ovo ponavljajuæe plaæanje.
            '800.100.501' => 'ERROR_REORDER_BACKEND',

            '700.300.300' => 'ERROR_REFUND_BACKEND', // Transakciju nije moguæe refundirati niti otkazati
    ...
    ],/*  else return 'ERROR_UNKNOWN'; // "Nažalost, vaša transakcija nije uspela. Molimo pokušajte ponovo.*/
    'BACKEND_ACTIONS_ERROR'=>[
            ...
            '700.400.560' => 'ERROR_RECEIPT_BACKEND',
            '700.400.561' => 'ERROR_RECEIPT_BACKEND'],//else            return 'ERROR_GENERAL_PROCESSING';
    'INREVIEW'=>[
            '000.400.000',
            '000.400.010',
            '000.400.020',
